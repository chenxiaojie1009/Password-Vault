...
class DeviceCreate(BaseModel):
    ...
    location: str = ""; notes: str = ""; is_network_involved: bool = False; device_level: str = "一级设备"
...
class DeviceUpdate(BaseModel):
    ...
    is_network_involved: Optional[bool] = None; device_level: Optional[str] = None
...
class DeviceResponse(BaseModel):
    ...
    is_network_involved: bool = False; device_level: str = "一级设备"; created_at: datetime; updated_at: datetime
...
class DeviceListItem(BaseModel):
    ...
    account_count: int = 0; is_network_involved: bool = False; device_level: str = "一级设备"; updated_at: datetime
    model_config = {"from_attributes": True}
